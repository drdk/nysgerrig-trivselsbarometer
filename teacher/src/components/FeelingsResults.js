...
class FeelingsResults extends Component {
    ...
    render() {
        ...
        return (<div>
            ...
            {diagram}
            <Button className={"alignRight " + classes.control} variant="raised" color="primary" onClick={() => this.goToConditions()}>{CommonData.getLocalized('seeConditionResults')}</Button>
        </div>);
    }
}
